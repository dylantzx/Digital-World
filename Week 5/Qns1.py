...
def roll_two_dices():
    n1 = random.randint(1,6) #will print 6 too
...
def play_craps():
    ...
    while True:
        ...
        if point==-1:              #At the initialisation of point == -1 (see line 29)
            if is_craps(sumn):  #if the sum is in the set of craps/ using the function as the condition for the if else statement
